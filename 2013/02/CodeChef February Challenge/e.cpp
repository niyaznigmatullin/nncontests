...
int goq(int i1, int j1, int i2, int j2, char d);
void goq2(int i1, int j1, int i2, int j2, char d);
int go(int i1, int j1, int i2, int j2, char d) {
    if (i2 - i1 < SM && j2 - j1 < SM) {
        return goq(i1, j1, i2, j2, d);
    }
...
int goq(int i1, int j1, int i2, int j2, char d) {
    ...
    if (j2 - j1 > i2 - i1) {
        for (int j3 = j1 + 1; j3 < j2; j3++) {
            int got = goq(i1, j1, i2, j3, d) + goq(i1, j3, i2, j2, d);
            if (got < ret) {
                ret = got;
                z = j3;
            }
        ...
        char nd = d == 'W' ? 'B' : 'W';
        for (int j3 = j1 + 1; j3 < j2; j3++) {
            int got = goq(i1, j1, i2, j3, nd) + goq(i1, j3, i2, j2, nd) + 1;
            if (got < ret) {
                ret = got;
                z = ~j3;
            }
        ...
        for (int i3 = i1 + 1; i3 < i2; i3++) {
            int got = goq(i1, j1, i3, j2, d) + goq(i3, j1, i2, j2, d);
            if (got < ret) {
                ret = got;
                z = i3;
            }
        ...
        char nd = d == 'W' ? 'B' : 'W';
        for (int i3 = i1 + 1; i3 < i2; i3++) {
            int got = goq(i1, j1, i3, j2, nd) + goq(i3, j1, i2, j2, nd) + 1;
            if (got < ret) {
                ret = got;
                z = ~i3;
            }
...
int main() {
    ...
    const int IT = n < 20 ? 1 : n < 30 ? 1 : n < 40 ? 1 : 1;
    ITT = n < 20 ? 40 : n < 30 ? 15 : n < 40 ? 15 : 4;
//    solve('B');
    solve2();
    for (int i = 0; i < IT; i++) {
//        memset(dp, -1, sizeof dp);
