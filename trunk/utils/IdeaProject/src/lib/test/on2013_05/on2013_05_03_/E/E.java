package lib.test.on2013_05.on2013_05_03_.E;
...
public class E {
    ...
    public void solve(int testNumber, FastScanner in, FastPrinter out) {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                ...
                if (Math.abs(a.distanceSquared(b) - points[i].distanceSquared(points[j])) > 1e-12) continue;
    ...
    static boolean opposite(Point3DDouble a, Point3DDouble b) {
        return Math.abs(a.vmul(b).lengthSquared()) < 1e-6;
    }
}
